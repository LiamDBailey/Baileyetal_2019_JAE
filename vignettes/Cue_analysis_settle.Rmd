...
(density <- ggplot()+
  ...
  geom_errorbar(data = bin_dat, aes(x = Density_numeric, ymin = lower, ymax = upper), width = 0.1, size = 0.325)+
  geom_point(data = bin_dat, aes(x = Density_numeric, y = mean_settle), size = 2, shape = 21, fill = "white", stroke = 1)+
  geom_text(data = bin_dat, aes(x = Density_numeric, y = lower - 0.03, label = n), size = 2, family = "sans")+
...
(fledge <- ggplot()+
  ...
  geom_errorbar(data = bin_dat, aes(x = Density_numeric, ymin = lower, ymax = upper), width = 0.035, size = 0.325)+
  geom_point(data = bin_dat, aes(x = Density_numeric, y = mean_settle), size = 2, shape = 21, fill = "white", stroke = 1)+
  geom_text(data = bin_dat, aes(x = Density_numeric, y = lower - 0.03, label = n), size = 2, family = "sans")+
...
#Save as pdf
ggsave("../plots/Figure_4.pdf", width = 18, height = 7.5, units = "cm", dpi = 600)
